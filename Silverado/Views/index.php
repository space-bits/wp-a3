...
?>
	...
	<div id="highlight" class="wrapper">
		<div id="reopening-message">
			We will be reopening on the 30th of April this year with a whole new range of features.<br>You're invited to come and see.
		</div>
		<div id="reopening-date">
			<span id="label">Reopening:</span>
			<span id="day">30</span>
	...
	<main class="wrapper yellow-bg round-first">
		<section>
			<h2>What's new?</h2>
			<p>You asked, we've answered. A modern and updated movie theatre now close to you.</p>
			<p> Over the last few months, we've gone through a series of changes to bring our cinema up to the modern standard. We've installed new seating, we've installed new projection technologies, and we've installed fuller, crisper sound technologies. </p>
			<p>Any and all questions can be answered via <a href="/contact">the contact page.</a> </p>
		</section>
